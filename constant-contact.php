...
function gConstantcontact_admin_options()
{
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="3"><tr><td width="61%" align="left">
	<?php
	...
	<td width="39%" align="left" valign="middle" style="border-left:dotted;padding-left:10px;">
	<h2><?php echo wp_specialchars( 'About Plugin' ); ?></h2>
    Plug-in created by <a target="_blank" href='http://www.gopiplus.com/'>Gopi</a>. <br /> 
    <a target="_blank" href='http://www.gopiplus.com/work/feedback-suggestion/'>click here</a> to post suggestion or comments or feedback.  <br /> 
    <a target="_blank" href='http://www.gopiplus.com/work/2010/07/18/constant-contact/'>click here</a> to see LIVE demo & More info.  <br /> 
    <a target="_blank" href='http://www.gopiplus.com/work/plugin-list/'>click here</a> To download my other plugins.  <br /> 

	</td></tr></table>
	</form>
    <hr />
	<h2><?php echo wp_specialchars( 'Constant Contact Plug-in' ); ?></h2>
    ...
    <h2><?php echo wp_specialchars( 'About Plugin' ); ?></h2>
    Plug-in created by <a target="_blank" href='http://www.gopiplus.com/'>Gopi</a>. <br /> 
    <a target="_blank" href='http://www.gopiplus.com/work/feedback-suggestion/'>click here</a> to post suggestion or comments or how to improve this plugin.  <br /> 
    <a target="_blank" href='http://www.gopiplus.com/work/2010/07/18/constant-contact/'>click here</a> to see LIVE demo & More info.  <br /> 
    <a target="_blank" href='http://www.gopiplus.com/work/plugin-list/'>click here</a> To download my other plugins.  <br /> 
    ...
    <a target="_blank" href="http://www.constantcontact.com/">Learn more about Constant Contact & sign up </a><br />
	<?php
...
{
	add_options_page('Constant contact', 'constant-contact', 7, __FILE__, 'gConstantcontact_admin_options' );
}

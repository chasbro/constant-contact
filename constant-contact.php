	...
	<div class="wrap">
		<div class="form-wrap">
			...
			{	
				...
				$gcc_username = stripslashes(trim($_POST['gcc_username']));
				$gcc_password = stripslashes(trim($_POST['gcc_password']));
				$gcc_group = stripslashes(trim($_POST['gcc_group']));		
				$gcc_title = stripslashes(trim($_POST['gcc_title']));
				$gcc_caption = stripslashes(trim($_POST['gcc_caption']));
				$gcc_adminemail = stripslashes(trim($_POST['gcc_adminemail']));
				$gcc_with_in_textbox = stripslashes(trim($_POST['gcc_with_in_textbox']));
				$gcc_button = stripslashes(trim($_POST['gcc_button']));
				$gcc_fromemail = stripslashes(trim($_POST['gcc_fromemail']));
				$gcc_adminmail = stripslashes(trim($_POST['gcc_adminmail']));
				$gcc_adminmail_subject = stripslashes(trim($_POST['gcc_adminmail_subject']));
				$gcc_adminmail_content = stripslashes(trim($_POST['gcc_adminmail_content']));
				$gcc_usermail = stripslashes(trim($_POST['gcc_usermail']));
				$gcc_usermail_subject = stripslashes(trim($_POST['gcc_usermail_subject']));
				$gcc_usermail_content = stripslashes(trim($_POST['gcc_usermail_content']));
				$gcc_homeurl = stripslashes(trim($_POST['gcc_homeurl']));
...
function gcc_add_javascript_files() 
{
	if (!is_admin())
	{
		wp_enqueue_script( 'gcc_ajax', get_option('siteurl').'/wp-content/plugins/constant-contact/class/gcc_ajax.js');
		wp_enqueue_style( 'gcc_custom', get_option('siteurl').'/wp-content/plugins/constant-contact/class/gcc_custom.css','','','screen');
	}
}    

...
function gConstantcontact_activation()
{
	...
	add_option('gConstantcontact_widget_textbox_style', "font-family:Verdana;font-size: 12px;color: #000000;background-color: #FFFFFF;border: thin groove #CCCCCC;width:120px;");
